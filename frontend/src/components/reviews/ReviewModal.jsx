...
import { Star, X, Sparkles, Send, MessageSquare, AlertCircle, CheckCircle } from "lucide-react";
...
export default function ReviewModal({ isOpen, onClose, onSubmitSuccess, defaultName = "" }) {
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-[#8B1A1A] mb-2">
              Your Full Name <span className="text-[#FF6B1A]">*</span>
            </label>
            <input
              type="text"
              value={name}
              ...
              required
              className="w-full px-4 py-3 rounded-2xl bg-white border border-[#E8DCC4] text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#FF6B1A]/30 focus:border-[#FF6B1A] text-sm transition-all"
            />
          </div>
